  ...
  var _methods =  {
        ...
        SidebarCTOR : {
                    ...
                    return $.Deferred( function() {
                          ...
                          ( function() {
                                return $.Deferred( function() {
                                      ...
                                      // console.log(expanded ? sb._getExpandedHeight() + 'px' : sb.container.height() + 'px'); // Changed //
                                      ...
                                      // if (clickCounter % 2 != 0)   {
                                      //   $('div.sidebar.s1.collapsed').css({'display': 'none', 'transition': '1.5s'});
                                      // }
                                      // else {
                                      //   $('div.sidebar.s1.collapsed').css({'display': 'block', 'transition': '1.5s'});
                                      // }
                                      ...
                                      _.delay( function() {
                                            _dfd.resolve();
                                      }, 100 );//transition: width .35s ease-in-out;
                                }).promise();
                          })().done( function() {
                                // Changed //
                                if (clickCounter % 2 != 0) {
              ...
              _isExpandable : function() {
                    return _.isFunction( window.matchMedia ) && matchMedia( 'only screen and (min-width: 180px) and (max-width: 2000px)' ).matches; // Changed //
              },
