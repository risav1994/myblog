...
<nav class="<?php echo implode(' ', $mobile_menu_classes ); ?>" id="<?php echo $mobile_menu_id; ?>" data-menu-id="<?php echo hu_get_menu_id( 'header'); ?>">
  <div class="mobile-title-logo-in-header"><?php hu_print_logo_or_title();//gets the logo or the site title ?><?php hu_print_title_mobile();//gets the logo or the site title ?></div> <!-- Changed -->
